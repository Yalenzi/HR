...
الدكتور {{managerName}}`,
          variables: [
            { key: "employeeName", label: "اسم الزميل", type: "text", required: true },
            { key: "managementName", label: "اسم الإدارة", type: "text", required: true },
            { key: "occasionType", label: "مناسبة التهنئة", type: "select", required: true, options: ["تكليف", "تمديد تكليف", "ترقية", "تكريم", "إنجاز متميز", "حصول على شهادة", "تخرج", "تعيين", "نجاح في مهمة", "تميز في الأداء"] },
            { key: "occasionDate", label: "تاريخ المناسبة", type: "date", required: true },
            { key: "customMessage", label: "النص المخصص", type: "textarea", required: true },
            { key: "managerName", label: "اسم المدير", type: "text", required: true, default: "د. فواز جمال الديدب" },
            { key: "employeePhoto", label: "الصورة الشخصية", type: "file", required: false },
            { key: "backgroundImage", label: "صورة الخلفية", type: "file", required: false },
            { key: "textPosition", label: "موضع النص", type: "select", required: false, options: ["top", "center", "bottom", "overlay"] },
            { key: "backgroundColor", label: "لون الخلفية", type: "color", required: false },
            { key: "textColor", label: "لون النص", type: "color", required: false }
          ],
          isActive: true
        },
        {
